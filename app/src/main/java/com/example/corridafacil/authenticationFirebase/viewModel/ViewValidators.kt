...
import com.example.corridafacil.utils.ValidatorsFieldsForms.isValidFormatName
...
class ViewValidators(private val componentsViewActivity: ComponentsViewActivity) {
    ...
    fun validateFieldsFormAddEmail(){
        formatIsValidFormFields.put("nome" , isValidFormatName(componentsViewActivity.getValueFieldEdtiTextToString(
            R.id.editTextNome)))
        formatIsValidFormFields.put("sobrenome",isValidFormatName(componentsViewActivity.getValueFieldEdtiTextToString(
            R.id.editTextSobrenome)))
        formatIsValidFormFields.put("email", isValidEmail(componentsViewActivity.getValueFieldEdtiTextToString(
            R.id.editTextFormEmail)))
        formatIsValidFormFields.put("senha", isValidPassword(componentsViewActivity.getValueFieldEdtiTextToString(
            R.id.editTextFormPassword)))
